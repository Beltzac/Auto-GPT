...
def parse_arguments():
    ...
    parser.add_argument('--caching', action='store_true', help='Enable Caching of OpenAI Inferencing calls')
    ...
    if args.caching:
        print_to_console("Cacheing Mode: ", Fore.GREEN, "ENABLED")
        cfg.set_caching(True)
